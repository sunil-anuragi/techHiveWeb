                ...
                <div class="row align-items-center">
                    <div class="col-xl-5">
                        <div class="tp-breadcrumb-content">
                            ...
                            <p class="tp-breadcrumb-body"><span><a class="home" href="index.html">Home <span class="spacing">/</span> </a></span>Service details</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="tp-service-details-wrapper-left">
                            ...
                            <div class="tp-service-details-contact-box mb-50 wow fadeInUp">
                                <div class="tp-service-details-contact text-center" data-background="assets/img/service/service-details-price.jpg">
                                    <h4 class="tp-service-details-contact-title">Contact with <br>
                                        us for any <br>
                                        advice</h4>
                                    <div class="tp-service-details-contact-btn">
                                        <a class="tp-btn" rel="noreferrer" href="contact.html" target="_blank"><span>contact with us</span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="tp-service-details-box wow fadeInUp">
                                <div class="tp-service-details-call-item d-flex align-items-center">
                                    <div class="tp-service-details-call-icon p-relative z-index-11">
                                        <a href="tel:+997868765"><img src="assets/img/service/service-details-calll-icon.svg" alt=""></a>
                                    </div>
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-6">
                        <div class="tp-service-details-wrapper ml-35">
                            ...
                            <div class="tp-service-details-thumb mb-35 wow fadeInUp">
                                <img src="assets/img/service/service-details-img.jpg" alt="">
                            </div>
