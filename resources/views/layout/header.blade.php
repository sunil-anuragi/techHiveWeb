 <!-- pre loader area start -->
    <div class="loader-wrapper">
        ...
        <div class="loader-brand-icon"><img src="{{asset('public/template/assets/img/logo/preloder.png')}}" alt=""></div>
    </div>
    <!-- pre loader area end -->
    <!-- back to top start -->
    ...
    <div class="tpoffcanvas-area">
        <div class="tpoffcanvas">
            ...
            <div class="tpoffcanvas__logo">
                <a href="{{ url('/') }}">
                    <img style="width: 147px; height: 44px;" src="{{asset('public/template/assets/img/logo/logo-2.jpeg')}}" alt="">
                </a>
            </div>
            ...
            <div class="tpoffcanvas__contact-info">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href="mailto:teczainfo@mail.com"><span class="__cf_email__">techhive234@gmail.com</span></a>
                    </li>
                    <li>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-8">
                        <div class="tp-header-2-top-address">
                            <span><img src="{{asset('public/template/assets/img/header/location.svg')}}" alt=""><a href="https://www.google.com/maps/@41.6758525,-86.2531698,18.17z"> Althan surat</a></span>
                            <span><img src="{{asset('public/template/assets/img/header/message.svg')}}" alt=""> <a href="mailto:teczainfo@mail.com">techhive234@gmail.com</a></span>
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <div class="tp-header-top-right">
                            ...
                            <div class="tp-header-top-social">
                                <a target="_blank" href="https://www.facebook.com/share/14FsDYDWWge/"><i class="fa-brands fa-facebook"></i></a>
                                <a target="_blank" href="https://www.instagram.com/tech_hive__?igsh=MW0xY2hwNDI4dWw4Mw=="><i class="fa-brands fa-instagram"></i></a>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-4 col-md-4 col">
                           <div class="tp-header-logo">
                                <a href="{{ url('/') }}"><img style="width: 147px; height: 44px;" src="{{asset('public/template/assets/img/logo/logo-2.jpeg')}}" alt=""></a>
                           </div>
                        </div>
                               ...
                               <!-- <div class="tp-header-shop d-none d-md-block p-relative">
                                    ...
                                    <div class="minicart">
                                        <div class="cart-content-wrap d-flex align-items-center justify-content-between">
                                            <div class="cart-img-info d-flex align-items-center">
                                                <div class="cart-thumb">
                                                    <a href="{{asset('public/template/shop-details.html')}}"> <img src="{{asset('public/template/assets/img/shop/shop-1.jpg')}}" alt=""></a>
                                                </div>
                                                <div class="cart-content">
                                                    <h5 class="cart-title"><a href="{{asset('public/template/shop-details.html')}}">Mug with pencil</a></h5>
                                        ...
                                        <div class="cart-content-wrap d-flex justify-content-between align-items-center">
                                            <div class="cart-img-info  d-flex align-items-center">
                                                <div class="cart-thumb">
                                                    <a href="{{asset('public/template/shop-details.html')}}"> <img src="{{asset('public/template/assets/img/shop/shop-2.jpg')}}" alt=""></a>
                                                </div>
                                                <div class="cart-content">
                                                    <h5 class="cart-title"><a href="{{asset('public/template/shop-details.html')}}">Student bag</a></h5>
                                                    <span> $ 22.9 <del>$39.9 </del></span>
                                                </div>
                                            </div>
                                            <div class="cart-del-icon">
                                        ...
                                        <div class="minicart-btn">
                                            <a class="cart-btn mb-10" href="{{asset('public/template/cart.html')}}"><span>Shopping Cart</span></a>
                                            <a class="cart-btn cart-btn-black" href="{{asset('public/template/checkout.html')}}"><span>Checkout</span></a>
                                        </div>
                                    </div>
                                </div>-->
                                ...
                                <div class="tp-header-button d-none d-lg-block">
                                    <a class="tp-header-btn" rel="noreferrer" href="{{route('contact')}}" target="_blank"><span>Get a Quote</span></a>
                                </div>
