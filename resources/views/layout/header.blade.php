 ...
 <div class="loader-wrapper">
     ...
     <div class="loader-brand-icon"><img src="{{ asset('public/template/assets/img/logo/preloder.png') }}" alt="">
     </div>
 </div>
 <!-- pre loader area end -->
 <!-- back to top start -->
         ...
         <div class="tpoffcanvas__contact-info">
             ...
             <ul>
                 <li>
                     ...
                     <a href="https://www.google.com/maps/@23.8223586,90.3661283,15z" target="_blank">Manchester 21,
                         Zurich, CH</a>
                 </li>
                 <li>
             ...
             <div class="row align-items-center">
                 <div class="col-xl-8">
                     <div class="tp-header-2-top-address">
                         <span><img src="{{ asset('public/template/assets/img/header/location.svg') }}"
                                 alt=""><a href="https://www.google.com/maps/@41.6758525,-86.2531698,18.17z">
                                 Althan surat</a></span>
                         <span><img src="{{ asset('public/template/assets/img/header/message.svg') }}" alt="">
                             <a href="mailto:teczainfo@mail.com">techhive234@gmail.com</a></span>
                     </div>
                 </div>
                 <div class="col-xl-4">
                     ...
                     <div class="col-xl-4 col-lg-8 col-md-8 col">
                         <div class="tp-header-right">
                             ...
                             <div class="tp-header-button d-none d-lg-block">
                                 <a class="tp-header-btn" rel="noreferrer" href="{{ route('contact') }}"
                                     target="_blank"><span>Get a Quote</span></a>
                             </div>

                             <!-- header mobile button -->
                             <div class="tp-header-mobile-button">
                                 <button class="tp-header-mobile-btn tp-menu-bar d-xl-none"><i
