                ...
                <div class="row align-items-center">
                    <div class="col-xl-5">
                        <div class="tp-breadcrumb-content">
                            ...
                            <p class="tp-breadcrumb-body"><span><a class="home" href="index.html">Home <span class="spacing">/</span> </a></span>OUR service</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="tp-service-2-wrapper wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                            <div class="tp-service-2-thumb">
                                <a href="service-details.html"><img src="assets/img/service/service-2-img4.jpg" alt=""></a>
                            </div>
                            <div class="tp-service-2-content">
                                <div class="tp-service-2-icon">
                                    <span><i class="flaticon-coding"></i></span>
                                </div>
                                <h4 class="tp-service-2-title"><a href="service-details.html">app development</a></h4>
                                <p class="tp-service-2-paragraph">Outsourcing is just a tool my own
                                    achieve and business</p>
                            </div>
                            <div class="tp-service-2-button">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="tp-service-2-wrapper wow fadeInUp" data-wow-delay=".5s" data-wow-duration="1s">
                            <div class="tp-service-2-thumb">
                                <a href="service-details.html"><img src="assets/img/service/service-2-img5.jpg" alt=""></a>
                            </div>
                            <div class="tp-service-2-content">
                                <div class="tp-service-2-icon">
                                    <span><i class="flaticon-gear"></i></span>
                                </div>
                                <h4 class="tp-service-2-title"><a href="service-details.html">security systmes</a></h4>
                                <p class="tp-service-2-paragraph">Outsourcing is just a tool my own
                                    achieve and business</p>
                            </div>
                            <div class="tp-service-2-button">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="tp-service-2-wrapper wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1s">
                            <div class="tp-service-2-thumb">
                                <a href="service-details.html"><img src="assets/img/service/service-2-img6.jpg" alt=""></a>
                            </div>
                            <div class="tp-service-2-content">
                                <div class="tp-service-2-icon">
                                    <span><i class="flaticon-data-visualization"></i></span>
                                </div>
                                <h4 class="tp-service-2-title"><a href="service-details.html">data visualization</a></h4>
                                <p class="tp-service-2-paragraph">Outsourcing is just a tool my own
                                    achieve and business</p>
                            </div>
                            <div class="tp-service-2-button">
