                     ...
                     <div class="col-xl-5">
                         <div class="tp-breadcrumb-content">
                             ...
                             <p class="tp-breadcrumb-body"><span><a class="home" href="{{ url('/') }}">Home <span
                                             class="spacing">/</span> </a></span>contact us</p>
                         </div>
                     </div>
                 </div>
             </div>
                     ...
                     <div class="col-xl-5 col-lg-6">
                         <div class="tp-contact-page-wrapper ml-80 wow fadeInUp">
                             <div class="tp-contact-page-content mb-25">
                                 ...
                                 <a class="tp-contact-page-paragrap"
                                     href="https://www.google.com/maps/place/Althan,+Surat,+Gujarat/@21.1538227,72.7978953,15z/data=!3m1!4b1!4m6!3m5!1s0x3be051ffd68cfdfd:0x50eef593fa09ce97!8m2!3d21.1557806!4d72.8091715!16s%2Fg%2F1td46f9f?entry=ttu&g_ep=EgoyMDI1MDYyMy4yIKXMDSoASAFQAw%3D%3D">Althan
                                     surat</a>
                             </div>
                             <div class="tp-contact-page-content mb-25">
                                 <h4 class="tp-contact-page-title">free customer care</h4>
                                 <a class="tp-contact-page-paragrap" href="tel:7567329956">7567329956</a>
                                 <a class="tp-contact-page-paragrap" href="tel:9824072880">9824072880</a>
                             </div>
                             <div class="tp-contact-page-content mb-35">
                                 <h4 class="tp-contact-page-title">need live support</h4>
                                 <a class="tp-contact-page-paragrap"
                                     href="mailto:techhive234@gmail.com">techhive234@gmail.com</a>
         ...
         $('#contactForm').on('submit', function(e) {
             ...
             function showError(selector, message) {
                 $(selector).parent().append(
                     '<div class="error-message text-danger" style="font-size:14px; margin-top:4px;">' +
                     message + '</div>');
             }
             ...
             $.ajax({
                 ...
                 success: function(response) {
                     if (response.success) {
                         $('#formResponse').html(
                             '<div class="alert alert-success" id="successMessage">' + response
                             .message + '</div>');
                         $('#contactForm')[0].reset();
                         ...
                         setTimeout(function() {
                             $('#successMessage').fadeOut('slow', function() {
                                 $(this)
                                     .remove(); // Optional: remove the element from DOM
                             });
